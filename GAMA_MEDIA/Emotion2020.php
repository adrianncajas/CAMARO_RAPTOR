...
<body>
    ...
    <div class="container">
        ...
        <!-- Álbum de imágenes -->
        <div class="album">
            <img src="imagenes/EMOTION4.jpg" alt="Vehículo 1" onclick="openModal(this.src)">
            <img src="imagenes/EMOTION4.jpg" alt="Vehículo 1" onclick="openModal(this.src)">
        ...
        <div class="features">
        <p><strong>Modelo:</strong> Emotion 2022 full</p>
            <p><strong>Motor:</strong> 1.5L DOHC, 4 cilindros</p>
