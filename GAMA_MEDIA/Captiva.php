...
<body>
    ...
    <div class="container">
        ...
        <!-- Álbum de imágenes -->
        <div class="album">
            <img src="imagenes/CAPTIVA.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
            <img src="imagenes/CAPTIVA.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
        ...
        <div class="features">
            ...
            <p><strong>Modelo:</strong> Captiva 2023 full</p>
        ...
        <nav>
            <ul>
                ...
                <li><a href="reservacion_raptor.php">ver registros</a></li>
            </ul>
        </nav>
    </div>
