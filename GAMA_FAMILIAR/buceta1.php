...
<body>
    ...
    <div class="container">
        ...
        <!-- Álbum de imágenes -->
        <div class="album">
            <img src="imagenes/buceta2.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
            <img src="imagenes/buceta2.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
        ...
        <div class="features">
            ...
            <p><strong>Marca:</strong> Hunday</p>
            <p><strong>Modelo:</strong> XL 2023 full</p>
            <p><strong>Motor:</strong> 2.5L DOHC, 4 cilindros</p>
            <p><strong>Potencia:</strong> 109 HP a 6000 rpm</p>
            <p><strong>Consumo:</strong> 18 km/l combinado</p>
