...
<body>
    ...
    <div class="container">
        ...
        <!-- Álbum de imágenes -->
        <div class="album">
            <img src="imagenes/buceta4.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
            <img src="imagenes/buceta4.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
        ...
        <div class="features">
            ...
            <p><strong>Modelo:</strong> tracblazer 2023 full</p>
            <p><strong>Motor:</strong> 3.0L DOHC, 4 cilindros</p>
            <p><strong>Potencia:</strong> 109 HP a 6000 rpm</p>
            <p><strong>Consumo:</strong> 20 km/l combinado</p>
            <p><strong>Transmisión:</strong> Manual de 5 velocidades</p>
            <p><strong>Capacidad:</strong> 8 pasajeros</p>
            <p><strong>Valor por dia:</strong> 90</p>
            <p><strong>Estado:</strong> Disponible</p>
        </div>
        <nav>
            <ul>
                <li><a href="reservacion.php">Alquilar</a></li>
                <li><a href="gama_familiar.php">Ver más vehículos</a></li>
