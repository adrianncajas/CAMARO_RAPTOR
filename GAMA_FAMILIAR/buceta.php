...
<body>
    ...
    <div class="container">
        ...
        <!-- Álbum de imágenes -->
        <div class="album">
            <img src="imagenes/buceta1.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
            <img src="imagenes/buceta1.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
        ...
        <div class="features">
            ...
            <p><strong>Modelo:</strong> Sail Familiar full</p>
        ...
        <nav>
            <ul>
                <li><a href="teservacion.php">Alquilar</a></li>
