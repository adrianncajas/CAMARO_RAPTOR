...
<body>
    ...
    <div class="container">
        ...
        <!-- Álbum de imágenes -->
        <div class="album">
            <img src="imagenes/buceta3.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
            <img src="imagenes/buceta3.jpeg" alt="Vehículo 1" onclick="openModal(this.src)">
